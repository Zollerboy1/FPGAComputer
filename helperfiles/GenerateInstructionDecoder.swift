...
struct ControlWord: OptionSet, ExpressibleByIntegerLiteral {
    ...
    static let SAB: ControlWord = .init(rawValue: 1 << 18)
    static let FE:  ControlWord = .init(rawValue: 1 << 19)
    static let BI:  ControlWord = .init(rawValue: 1 << 20)
    static let BO:  ControlWord = .init(rawValue: 1 << 21)
    static let DI:  ControlWord = .init(rawValue: 1 << 22)
...
let instructionsTemplate: [Instruction] = [
    ...
    //                                  0                1                        2                 3                        4                        5              6              7
    .init(name: "ADDB",  steps: .CO | .AE, .RO | .IE | .CE, .SO | .BI | .ADD | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 0000
    .init(name: "SUBB",  steps: .CO | .AE, .RO | .IE | .CE, .SO | .BI | .SUB | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 0001
    .init(name: "INCB",  steps: .CO | .AE, .RO | .IE | .CE, .SO | .BI | .INC | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 0010
    .init(name: "DECB",  steps: .CO | .AE, .RO | .IE | .CE, .SO | .BI | .DEC | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 0011
    .init(name: "ANDB",  steps: .CO | .AE, .RO | .IE | .CE, .SO | .BI | .AND | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 0100
    .init(name: "ORB",   steps: .CO | .AE, .RO | .IE | .CE,  .SO | .BI | .OR | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 0101
    .init(name: "XORB",  steps: .CO | .AE, .RO | .IE | .CE, .SO | .BI | .XOR | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 0110
    .init(name: "NOTB",  steps: .CO | .AE, .RO | .IE | .CE, .SO | .BI | .NOT | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 0111
    .init(name: "SHLB",  steps: .CO | .AE, .RO | .IE | .CE, .SO | .BI | .SHL | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 1000
    .init(name: "SHRB",  steps: .CO | .AE, .RO | .IE | .CE, .SO | .BI | .SHR | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 1001
    .init(name: "ASLB",  steps: .CO | .AE, .RO | .IE | .CE, .SO | .BI | .ASL | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 1010
    .init(name: "ASRB",  steps: .CO | .AE, .RO | .IE | .CE, .SO | .BI | .ASR | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 1011
    .init(name: "GTB",   steps: .CO | .AE, .RO | .IE | .CE,  .SO | .BI | .GT | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 1100
    .init(name: "EQB",   steps: .CO | .AE, .RO | .IE | .CE,  .SO | .BI | .EQ | .SAB,              .MR,                       0,                       0,             0,             0), // 1001 1101
    ...
    //                                  0                1                        2                 3                        4                        5              6              7
    .init(name: "LADDB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .AI, .SO | .BI | .ADD | .SAB,           .MR,             0), // 1011 0000
    .init(name: "LSUBB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .AI, .SO | .BI | .SUB | .SAB,           .MR,             0), // 1011 0001
    .init(name: "LINCB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .BI, .SO | .BI | .INC | .SAB,           .MR,             0), // 1011 0010
    .init(name: "LDECB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .BI, .SO | .BI | .DEC | .SAB,           .MR,             0), // 1011 0011
    .init(name: "LANDB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .AI, .SO | .BI | .AND | .SAB,           .MR,             0), // 1011 0100
    .init(name: "LORB",  steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .AI,  .SO | .BI | .OR | .SAB,           .MR,             0), // 1011 0101
    .init(name: "LXORB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .AI, .SO | .BI | .XOR | .SAB,           .MR,             0), // 1011 0110
    .init(name: "LNOTB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .BI, .SO | .BI | .NOT | .SAB,           .MR,             0), // 1011 0111
    .init(name: "LSHLB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .AI, .SO | .BI | .SHL | .SAB,           .MR,             0), // 1011 1000
    .init(name: "LSHRB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .AI, .SO | .BI | .SHR | .SAB,           .MR,             0), // 1011 1001
    .init(name: "LASLB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .AI, .SO | .BI | .ASL | .SAB,           .MR,             0), // 1011 1010
    .init(name: "LASRB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .AI, .SO | .BI | .ASR | .SAB,           .MR,             0), // 1011 1011
    .init(name: "LGTB",  steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .AI,  .SO | .BI | .GT | .SAB,           .MR,             0), // 1011 1100
    .init(name: "LEQB",  steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AE | .CE,               .RO | .AI,  .SO | .BI | .EQ | .SAB,           .MR,             0), // 1011 1101
    ...
    //                                  0                1                        2                 3                        4                        5              6              7
    .init(name: "CADDB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AI | .CE, .SO | .BI | .ADD | .SAB,                     .MR,             0,             0), // 1101 0000
    .init(name: "CSUBB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AI | .CE, .SO | .BI | .SUB | .SAB,                     .MR,             0,             0), // 1101 0001
    .init(name: "NOP",   steps: .CO | .AE, .RO | .IE | .CE,                     .MR,                0,                       0,                       0,             0,             0), // 1101 0010
    .init(name: "NOP",   steps: .CO | .AE, .RO | .IE | .CE,                     .MR,                0,                       0,                       0,             0,             0), // 1101 0011
    .init(name: "CANDB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AI | .CE, .SO | .BI | .AND | .SAB,                     .MR,             0,             0), // 1101 0100
    .init(name: "CORB",  steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AI | .CE,  .SO | .BI | .OR | .SAB,                     .MR,             0,             0), // 1101 0101
    .init(name: "CXORB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AI | .CE, .SO | .BI | .XOR | .SAB,                     .MR,             0,             0), // 1101 0110
    .init(name: "NOP",   steps: .CO | .AE, .RO | .IE | .CE,                     .MR,                0,                       0,                       0,             0,             0), // 1101 0111
    .init(name: "CSHLB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AI | .CE, .SO | .BI | .SHL | .SAB,                     .MR,             0,             0), // 1101 1000
    .init(name: "CSHRB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AI | .CE, .SO | .BI | .SHR | .SAB,                     .MR,             0,             0), // 1101 1001
    .init(name: "CASLB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AI | .CE, .SO | .BI | .ASL | .SAB,                     .MR,             0,             0), // 1101 1010
    .init(name: "CASRB", steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AI | .CE, .SO | .BI | .ASR | .SAB,                     .MR,             0,             0), // 1101 1011
    .init(name: "CGTB",  steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AI | .CE,  .SO | .BI | .GT | .SAB,                     .MR,             0,             0), // 1101 1100
    .init(name: "CEQB",  steps: .CO | .AE, .RO | .IE | .CE,               .CO | .AE,  .RO | .AI | .CE,  .SO | .BI | .EQ | .SAB,                     .MR,             0,             0), // 1101 1101
...
for (i, instruction) in instructions.enumerated() {
    ...
    print("")
    print("//     S                 H")
    print("// DBBFASSSSSAACCCMOOIRRAL")
    print("// IOIEBO3210OIOEIROIEOIET")

    print("   \(instruction.steps.first!.rawValue, radix: 2, paddedToWidth: 23)   // 0 - \(flagsBits, radix: 2, paddedToWidth: 3) \(instructionMSB, radix: 2, paddedToWidth: 4) \(instructionLSB, radix: 2, paddedToWidth: 4) - \(instruction.name)")

    for (j, step) in instruction.steps.dropFirst().enumerated() {
        print("   \(step.rawValue, radix: 2, paddedToWidth: 23)   // \(j + 1)")
    }
}
